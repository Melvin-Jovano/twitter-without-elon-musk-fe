            ...
            <div class="list-wrap mt-1 p-3">
                ...
                <a href="#" class="text-decoration-none font-weight-light" v-for="index in 10" :key="index">
                    <div class="list-trending mb-1 p-2">
                        ...
                        <span class="d-block" style="font-size: 15px; color: #0f1419; font-weight: 700;">Home</span>
                        <span class="d-block" style="font-size: 13px; color: rgb(83, 100, 113);">10,540 Tweets</span>
                    </div>
                </a>
            </div>
        </div>
